...
public class App {
    public static void main(String[] args) {
        ...
        while (isRunning) {
            ...
            String output = UserInputs.getCommand(scanner);
            switch (output) {
                case "1":
                ...
                case "4":
                   ...
                   String contactByName = UserInputs.getName(scanner);
                ...
                case "exit":
                    ...
                    return;
                default:
                    Message.print("Invalid command! Please Choose numbers (1-5) or Q to exit program.");
                    break;
